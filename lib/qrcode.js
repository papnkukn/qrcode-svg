...
QRCode.prototype.svg = function(opt) {
  ...
  switch (opt.container) {
    case "svg":
      svg += '<?xml version="1.0" standalone="no"?>' + EOL + '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="' + width + '" height="' + height + '">' + EOL;
      svg += rect;
      svg += '</svg>';
      break;
...
QRCode.prototype.save = function(file, format, callback) {
